const ServiceCard = ({ imgURL, label, subtext }) => {
  return (
    <div className='flex-1 sm:min-w-[200px] sm:min-h-[350px] w-full  shadow-3xl rounded-2xl px-10 py-5'>
      ...
      <h3 className='font-palanquin leading-normal mt-4 text-2xl font-bold'>
        {label}
      </h3>
